  ...
  <IconWrapper>
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h10a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.707 4.293l.586-.586a2 2 0 012.828 0l2 2a2 2 0 010 2.828l-2 2a2 2 0 01-2.828 0l-.586-.586a2 2 0 00-2.828 0L7.707 10.5m0-6.207l-2 2a2 2 0 000 2.828l2 2a2 2 0 002.828 0l.586-.586a2 2 0 012.828 0l2 2a2 2 0 010 2.828l-2 2a2 2 0 01-2.828 0l-.586-.586a2 2 0 00-2.828 0"
      />
    </svg>
  </IconWrapper>
);
...
const navItems = [
  ...
  {
    id: 'connect',
    label: 'Connect With A Professional',
    icon: <BriefcaseIcon />,
    path: '/connect',
  },
  {
      ...
      <div className="h-20 flex items-center justify-center border-b border-white/20 px-4">
        <div className="text-center flex items-center justify-center">
          <Link to="/dashboard">
            ...
            <div className="text-xs text-white/80 font-lato mt-1 font-bold">
              "It Starts at Home."
            </div>
          </Link>
        </div>

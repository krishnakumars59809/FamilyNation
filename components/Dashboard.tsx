...
const dashboardItems = [
  {
    ...
    description:
      "Find vetted therapists, counselors, and specialists tailored to your family's needs.",
  ...
  },
  {
    ...
    description:
      "Connect with families facing similar challenges in safe, moderated spaces.",
  ...
  },
  {
    ...
    description:
      "Access curated articles, guides, worksheets, and expert advice.",
  ...
  },
  {
    ...
    description:
      "Learn from family experts in live Q&A sessions and recorded workshops.",
  ...
  return (
    <div className="animate-fade-in min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-6">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 mb-8">
        <div className="flex flex-col lg:flex-row items-center justify-between mb-6">
          <div className="text-center lg:text-left mb-4 lg:mb-0">
            ...
            <p className="text-xl text-[#0D9488] mt-2 font-lato italic">
              "It Starts at Home."
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        {dashboardItems.map((item, index) => (
          ...
          >
            ...
            {/* Icon Container */}
            <div
              className={`${item.color} p-5 rounded-2xl mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 shadow-lg`}
            >
              {item.icon}
            </div>
      ...
      <div className="bg-gradient-to-r from-[#1E3A8A] via-[#0D9488] to-[#1E3A8A] p-10 rounded-2xl shadow-xl text-white relative overflow-hidden">
        ...
        <h2 className="text-4xl font-bold mb-8 font-montserrat text-center relative z-10">
          Why Choose FamilyNation?
        </h2>
        <div className="grid md:grid-cols-2 gap-10 relative z-10">
          <div>
            ...
            <p className="leading-relaxed font-lato text-lg">
              To empower families with predictive insights, curated resources,
              and compassionate support to overcome hardship and build stronger,
              healthier relationships that ripple outward into communities.
            </p>
          </div>
          <div>
            <h3 className="text-2xl font-bold mb-4 font-montserrat flex items-center">
            ...
            <ul className="space-y-3 font-lato text-lg">
              <li className="flex items-start">
                ...
                <strong>Problem-first focus</strong> - We start with your
                family's reality
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#34D399] rounded-full mr-3 mt-2 flex-shrink-0"></span>
                <strong>Predictive analytics</strong> - Hazel forecasts
                potential outcomes
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#F87171] rounded-full mr-3 mt-2 flex-shrink-0"></span>
                <strong>Curated resources</strong> - All vetted for trust and
                quality
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-[#FACC15] rounded-full mr-3 mt-2 flex-shrink-0"></span>
                <strong>Whole-family view</strong> - Addressing interconnected
                struggles
              </li>
            </ul>
          </div>
      ...
      <div className="mt-12 text-center bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        <h3 className="text-2xl font-bold text-[#1E3A8A] mb-4 font-montserrat">
          Ready to Take the First Step?
        </h3>
        <p className="text-gray-700 text-lg mb-6 font-lato max-w-2xl mx-auto">
          <strong>Remember:</strong> Problems in the home don't stay there.
          Solving them improves outcomes in schools, workplaces, and society.
        </p>
        <button
          onClick={() => setChatbotOpen(true)}
